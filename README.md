...
3. **1:22 - 3:00 Сравнение результатов работы на английском языке**:
    - Повторение шага создания задания и просмотра результата транскрипции для английского языка.

4. **3:10 - 3:54 Сравнение результатов работы на итальянском языке**:
    - Повторение шага создания задания и просмотра результата транскрипции для итальянского языка.
